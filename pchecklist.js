...
var passwordCheckOld = function () 
{
  ...
  else
  {
     ...
     for (var x=0; x < arrayBadPasswords.length; x++)
     {
        //If the password is listed on the array it returns "This is a bad password" in string output
        if (stringPassword === arrayBadPasswords[x])
        {
   ...
   //If the password hasn't triggered the IF statements than the password has passed the test, the output is "This is a good password."
   else
   {
